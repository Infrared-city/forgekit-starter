...
var HttpClient = class {
  ...
  async post(path, data, options = {}) {
    ...
    if (options.bigPayload && this.gatewayBaseUrl && !options.compress && !options.gzip) {
      const json2 = await postWithBigPayload({
        url,
        body: payload,
        authHeaders: { ...headers },
        ...
        parseEnvelope: (resp) => {
          ...
          return resp.bodyJson ?? void 0;
        }
      });
      if (options.decompressResult) {
        return decompressResultField(json2, this.logger);
      }
      return json2;
    }
    ...
    if (options.decompressResult) {
      return decompressResultField(json, this.logger);
    }
    return json;
  }
  /**
...
//# sourceMappingURL=chunk-HHRINQ6B.js.map